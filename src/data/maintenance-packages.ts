...
export const maintenancePackages: MaintenancePackage[] = [
  ...
  },
  {
    ...
    features: [
      { label: 'Wekelijkse updates met restore-point', primary: true },
      { label: 'Dagelijkse backups', primary: true },
      { label: 'Dagelijkse beveiligingsscan op kwetsbaarheden', primary: true },
      { label: 'Premium plug-inlicenties t.w.v. €350+/jaar', highlight: true, primary: true },
      { label: '30 minuten kleine reparaties per maand', highlight: true, primary: true },
      ...
      { label: 'SEO-posities bijhouden tot 10 zoekwoorden' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Dagelijkse beveiligingsscan op kwetsbaarheden', primary: true },
      { label: 'Premium plug-inlicenties t.w.v. €350+/jaar', highlight: true, primary: true },
      { label: '1 uur kleine reparaties per maand', highlight: true, primary: true },
      { label: 'Webhosting inbegrepen (optioneel)', primary: true },
      { label: '24/7 monitoring van je uptime' },
      { label: 'Uitgebreide spambescherming' },
      { label: 'Maandelijkse Core Web Vitals check' },
      { label: 'Databaseoptimalisatie elke maand' },
      { label: 'Doorlopende afbeeldingsoptimalisatie' },
      { label: 'SEO-posities bijhouden tot 100 zoekwoorden' },
      { label: 'Kapotte links monitoren' },
