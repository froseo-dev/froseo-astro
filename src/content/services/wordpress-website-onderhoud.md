...
statsRibbon:
  - value: '60+'
    label: 'WordPress-sites in beheer'
  - value: '15+'
...
painPoints:
  ...
  - icon: 'alertBurst'
    title: Een plug-in-update sloopt zomaar je pagina
    body: 'Auto-updates klinken makkelijk, totdat een nieuwe versie je formulier of paginabouwer breekt. Je merkt het pas als iemand belt dat het bestelformulier het niet doet.'
  - icon: 'archiveStack'
    title: Backups die alleen op papier bestaan
    body: 'Veel WordPress-sites hebben backups die al maanden niet meer goed wegschrijven. Of die nooit zijn teruggezet. Bij een crash kom je daar pijnlijk achter.'
  - icon: 'chartDown'
    title: Stille SEO-afkalving in Google
    body: 'Trage pagina''s, kapotte links, achterhaalde schema-markup: Google ziet het allemaal. Je positie zakt geleidelijk, zonder dat je het op één moment kan aanwijzen.'

comparison:
  title: 'WordPress zelf bijhouden versus'
  titleAccent: 'het uit handen geven.'
  withoutLabel: Zonder Froseo
  withLabel: Met Froseo
  items:
    - without: 'Plug-ins draaien al maanden op een verouderde versie'
      with: 'Elke update gecontroleerd uitgevoerd, met restore-point binnen handbereik'
    ...
    - without: 'Iedere security-mail voelt als jouw probleem om uit te zoeken'
      with: 'Wij vangen het op, jij krijgt een maandrapport van wat er gebeurd is'
    - without: 'Voor elke premium plug-in een eigen abonnementje en factuur'
      with: 'Elementor Pro, WP Rocket en Gravity Forms onder ons agency-account, jij betaalt niks extra'

approachStyle: timeline
approachSteps:
  - title: Pakket kiezen
    body: 'Je pikt het pakket dat past bij hoe groot of bedrijfskritisch je WordPress-site is. Per maand opzegbaar, of jaarlijks voor één maand gratis. Geen kleine lettertjes.'
...
faqs:
  ...
  - q: Hoe lang zit ik vast aan een onderhoudspakket?
    a: 'Nergens aan. Maandelijks abonnement is per maand opzegbaar, jaarlijks na afloop van het jaar. Geen langlopende contracten, geen stilzwijgende verlenging zonder bericht.'
  - q: Wat houdt de gratis WP-intake-audit in?
    a: 'Voor we starten kijken we naar de actuele staat van je WordPress-site. Welke WP-versie draait, welke plug-ins en thema''s zitten erin, hoe is je hosting opgezet, hoe staat het met beveiliging en backups, en hoe snel is de site. Is alles op orde, dan beginnen we direct met je gekozen pakket. Vinden we serieuze achterstand (verouderde versies, sporen van malware, broze hosting), dan stellen we een eenmalige opschoning voor met prijs vooraf. Jij beslist of we daarmee aan de slag gaan.'
  - q: Wat als mijn WordPress-site al gehackt blijkt te zijn?
  ...
  - q: Welke premium plug-in-licenties krijg ik bij het pakket?
    a: 'Bij Standard Care en Pro Care zit een set licenties van premium plug-ins inbegrepen, in totaal goed voor €350+ per jaar. Concreet onder andere ACF Pro, WP Rocket, Elementor Pro, WP Armour Premium en Gravity Forms. We installeren niet alles standaard, maar wat jouw site nodig heeft. Voor speciale gevallen hebben we een breder arsenaal beschikbaar. Bij Basic Care zit dit niet in het pakket, daar regel je eventuele licenties zelf.'
