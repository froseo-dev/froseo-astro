...
pricingTitle: 'Twee pakketten,'
pricingTitleAccent: 'één framework.'
pricingLead: 'Kies de tier die past bij waar je nu staat. Doorgroeien naar Online Plus kan op elk moment, zonder dat we de site opnieuw bouwen.'
...
comparison:
  title: 'Eenmalige website of een'
  titleAccent: 'website abonnement?'
  withoutLabel: 'Eenmalig project'
...
faqs:
  ...
  - q: Hoeveel inspraak heb ik op het ontwerp en de inhoud?
    a: 'Veel. We bouwen op een bewezen framework, maar binnen dat framework werken we mét je samen aan de invulling: huisstijl, structuur, content, foto''s, calls-to-action. Bij de intake bespreken we wat past bij jouw doelgroep en hoe je gevonden wilt worden. Tijdens de bouw kijken we samen of het klopt. Wat we niet doen: eindeloos schuiven met designs of het framework openbreken. Daar zijn maatwerktrajecten voor.'
  - q: Kan ik later overstappen van Online Start naar Online Plus?
    a: 'Ja, doorgroeien kan op elk moment. We hoeven de site niet opnieuw te bouwen: we breiden het pakket en de paginaset uit en passen je positierapportage aan. Andersom (van Plus terug naar Start) kan ook, mits het aantal pagina''s binnen Online Start past.'
  - q: Wat als ik meer dan de inbegrepen wijzigingstijd nodig heb?
